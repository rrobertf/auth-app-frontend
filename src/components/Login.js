...
function Login({ onLogin, onSwitchToRegister, loading }) {
  ...
  const validate = () => {
    ...
    if (!password) e.password = 'Por favor ingresa tu contraseña';
  ...
  const sideContent = (
    <div>
      <div style={{
        ...
        Seguridad<br />
        <em style={{ color: 'var(--accent)' }}>sin compromisos.</em>
      </div>
      <p style={{
        fontSize: 15,
        lineHeight: 1.55,
        ...
        SecureAuth protege tus credenciales con encriptación de nivel empresarial. Inicia sesión para acceder a tu cuenta de forma segura.
      </p>
      <div style={{
        display: 'flex',
        gap: 8,
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 13, fontWeight: 500, color: 'var(--fg)' }}>
            "La mejor autenticación que he usado."
          </div>
          <div style={{ fontSize: 11, color: 'var(--fg-muted)', marginTop: 2 }}>
            Roberto J., Full Stack Developer
          </div>
        </div>
      </div>
    </div>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        justifyContent: 'center',
        background: 'var(--bg-elev)',
        animation: shake ? 'shake 0.4s' : 'fadeIn 0.4s ease',
      }}>
        <div style={{ maxWidth: 320, margin: '0 auto', width: '100%' }}>
          ...
          <p style={{
            ...
            Inicia sesión en tu cuenta segura.
          </p>
          ...
          {errors.form && (
            <div style={{
              ...
              <svg width="16" height="16" viewBox="0 0 16 16" fill="none" style={{ flexShrink: 0, marginTop: 1 }}>
                ...
                <path d="M8 4v4.5M8 11v.01" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" />
              </svg>
